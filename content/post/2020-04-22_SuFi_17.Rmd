...
```
All of the SuFi games went on for a total duration of `r sum(sufi17$GameDuration)` days (except for short intervals between games). The average time for a SuFi game is `r mean(sufi17$GameDuration)` with a standard deviation of `r chron(times = sd(sufi17$GameDuration))`.
