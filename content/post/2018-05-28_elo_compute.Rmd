...
However, the ECO code distribution may have changed because of some transpositions.  I have stored the results of the TCEC Season 15 SuFi [here]("./leelasf2.csv").
...
```{r}
data2 %>%
  slice(n()) %>% select(Opening, ECO1, starts_with("ECO2")) %>% datatable()
```
